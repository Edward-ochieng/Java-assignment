...
public class DivisibilityTester {
    ...
    public static void main(String[] args) {
        ...
        // Check divisibility by 2 (even numbers)
        if (number % 2 == 0) {
        ...
        // Check divisibility by 4 (last two digits divisible by 4) - can be explained for older kids
        ...
        // You can add checks for other divisibility rules here following a similar logic
